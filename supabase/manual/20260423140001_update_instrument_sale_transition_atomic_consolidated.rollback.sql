...
-- the later migrations that further modified the seven-argument function
-- (20260728153000_sale_transition_certificate_name.sql,
-- 20260804010000_enforce_sale_price_precision_and_maximum.sql,
-- 20260804020000_harden_sale_lifecycle_authorization.sql) will break --
-- this rollback is only valid if those later migrations have also been
-- rolled back first (or were never applied), matching this repository's
