...
4. **네비게이션 구조 정리**
   - 사이드바에 모든 페이지 포함 또는 페이지 통합
   - `/instruments` 페이지 접근성 개선
   - **예상 시간**: 1-2일
...
2. **네비게이션 구조 정리** (1-2일) - **✅ 완료**
   - [x] 사이드바에 모든 페이지 포함 또는 페이지 통합
   - [x] `/instruments` 페이지 접근성 개선
   - [x] `/clients/analytics` 페이지 접근성 개선
