...
- [프로덕션 배포 가이드](./DEPLOYMENT.md) — repository CI vs hosted staging vs production DB vs Vercel app deploy, env contract (`env.template` + `check:env`), launch checklist. Email notification delivery is unsupported in the current release.
