...
- ✅ 작업 그룹화 - 100%
- ✅ 날짜 정보 표시 - 100%
- ✅ 검색 기능 - 100% (검색창 + 태그형 필터, 하이라이트)
- ✅ 정렬 기능 - 100% (날짜/우선순위/상태/타입, 오름차순/내림차순)
- ⚠️ 드래그 앤 드롭 - 0%
- ⚠️ 알림 기능 - 0%
...
- ✅ 설명 검색
- ✅ 검색어 하이라이트
- ✅ 태그형 필터 (타입/우선순위/상태/소유자)
- ✅ 디바운스 적용 (300ms)

**구현 파일:**

- `src/app/calendar/components/CalendarSearch.tsx` - 검색 컴포넌트
- `src/app/calendar/utils/searchUtils.ts` - 검색/정렬 유틸리티
...
- `src/app/calendar/utils/searchUtils.ts` - `sortTasks` 함수
- `src/app/calendar/page.tsx` - 정렬 상태 및 UI
...
**마지막 업데이트**: 2025-01-13 (검색/정렬 기능 완료 반영)
