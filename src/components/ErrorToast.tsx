...
export default function ErrorToast({ 
  ...
  const recoverySuggestions = showRecoverySuggestions ? errorHandler.getRecoverySuggestions(error) : []

  return (
    <div className={`max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto border-l-4 overflow-hidden ${getErrorColor(error.code)}`}>
      <div className="p-4">
