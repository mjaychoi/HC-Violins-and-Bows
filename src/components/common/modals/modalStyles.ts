...
export const modalStyles = {
  // 배경 오버레이 (어두운 배경 + 블러)
  overlay:
    'fixed inset-0 bg-gray-900 bg-opacity-20 backdrop-blur-sm z-50 flex items-center justify-center animate-in fade-in duration-200',

  // 모달 컨테이너 (라운드, 그림자, 애니메이션)
  container:
    'bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200',
  ...
  // 닫기 버튼
  closeButton:
    'p-2 text-gray-400 hover:text-gray-600 hover:bg-white rounded-lg transition-colors duration-200',
