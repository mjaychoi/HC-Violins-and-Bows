                  ...
                  <td className={classNames.tableCell}>
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        size="sm"
                        className="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-blue-600 bg-blue-100 hover:bg-blue-200 disabled:text-gray-400 disabled:bg-gray-50"
                        title={
                          sale.client?.email
                      ...
                      {status !== 'Refunded' ? (
                        <Button
                          ...
                          size="sm"
                          variant="danger"
                          className="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-white bg-rose-400 hover:bg-rose-500 border border-rose-400"
                          title="Issue refund"
                        >
                          <svg
                            className="w-3.5 h-3.5"
