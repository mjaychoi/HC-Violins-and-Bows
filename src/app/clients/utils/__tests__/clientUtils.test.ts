...
describe('Client Utils', () => {
  ...
  describe('formatClientContact', () => {
    it('should format contact with email and phone', () => {
      const result = formatClientContact(mockClient)
      expect(result).toBe('john@example.com • 123-456-7890')
    })
  ...
  describe('filterClients', () => {
    const clients: Client[] = [
      { ...mockClient, id: '1', first_name: 'John', last_name: 'Doe', tags: ['Owner'] },
      { ...mockClient, id: '2', first_name: 'Jane', last_name: 'Smith', tags: ['Musician'] },
      { ...mockClient, id: '3', first_name: 'Bob', last_name: 'Johnson', tags: ['Dealer'] }
    ]
