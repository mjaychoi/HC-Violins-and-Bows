...
// ✅ FIXED: Removed react-window virtualization
// With pagination (20 items per page), virtualization is unnecessary and causes issues with expanded rows
...
const ClientList = memo(function ClientList({
  ...
  // ✅ FIXED: Removed virtualization - pagination (20 items) makes it unnecessary
  // Virtualization with expanded rows causes layout issues and complexity
  // With pagination, we only show 20 items at a time, so virtualization is not needed

  // ✅ FIXED: Moved to file top to prevent recreation on every render
