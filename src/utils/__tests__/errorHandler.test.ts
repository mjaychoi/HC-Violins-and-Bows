import { errorHandler, isNetworkError, isValidationError, isAuthError } from '../errorHandler'
...
describe('ErrorHandler', () => {
  ...
  describe('handleSupabaseError', () => {
    it('should handle unique constraint violation', () => {
      ...
      const error = errorHandler.handleSupabaseError(supabaseError, 'Create client')
    ...
    it('should handle foreign key constraint violation', () => {
      ...
      const error = errorHandler.handleSupabaseError(supabaseError, 'Delete client')
    ...
    it('should handle RLS error', () => {
      ...
      const error = errorHandler.handleSupabaseError(supabaseError, 'Query data')
  ...
  describe('getUserFriendlyMessage', () => {
    ...
    it('should return original message for unknown error codes', () => {
      const error = errorHandler.createError('UNKNOWN_CODE' as ErrorCodes, 'Custom error')
      const message = errorHandler.getUserFriendlyMessage(error)
...
describe('Utility functions', () => {
  ...
  describe('isValidationError', () => {
    it('should identify validation errors', () => {
      expect(isValidationError({ code: ErrorCodes.VALIDATION_ERROR })).toBe(true)
